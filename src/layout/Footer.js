            ...
            <div className="copyright">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a className="border-bottom" href="#">Tourist BD</a>, All Right Reserved.

                        Designed By <a className="border-bottom" href="https://nazmul-rdo.netlify.app">Nazmul Hossain</a>
                    </div>
